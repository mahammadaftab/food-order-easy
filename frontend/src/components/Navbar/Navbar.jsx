...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-[#2D1B0E]/90 backdrop-blur-md py-3 shadow-xl' : 'bg-transparent py-6'}`}>
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="lg:hidden bg-[#2D1B0E] mt-4 py-4 px-4 border-t border-amber-900/30">
